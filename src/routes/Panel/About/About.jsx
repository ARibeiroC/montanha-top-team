  ...
  return (
    <Container id='about'>
        <div className="description-about">
          ...
          <p>
            Sob a liderança do renomado Professor Alderi Henrique da Silva, conhecido carinhosamente como Montanha, a Equipe Montanha Top Team se destaca como referência em Jiu-Jitsu na região. Localizada na Rua Almotacel, 105 - Jardim Guarani - Brasilândia, nossa academia é um refúgio para aqueles que buscam aprimorar suas habilidades, desenvolver sua disciplina e fortalecer o corpo e a mente.  
          </p>
          <p>
